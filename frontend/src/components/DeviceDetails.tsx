    ...
    <div className="modal-backdrop" role="presentation">
      <section className="device-dialog" role="dialog" aria-modal="true" aria-labelledby="device-details-title">
        ...
        <form onSubmit={submit} className="device-form">
          ...
          <div className="form-section-heading"><p className="eyebrow">Controles RouterOS</p><small>{readOnly && !canExecuteBlock ? 'Preview permanece disponível; cada capability é validada separadamente.' : readOnly ? 'Limites seguem a capability de banda; bloqueio/liberação segue a capability própria.' : 'Limites exigem preview e confirmação explícita antes da escrita.'}</small></div>
